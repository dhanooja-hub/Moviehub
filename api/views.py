...
class AlbumViewSetView(viewsets.ModelViewSet):
    ...
    # localhost:8000/api/albums/languages
    # method=get
    ...
    # localhost:8000/api/albums/directors/
    ...
    def add_track(self,request,*args,**kwargs):
        ...
        serializer_instance=TrackSerializer(data=request.data) #deserilaztion data=request.data
